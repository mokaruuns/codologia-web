...
Чтобы получить значение элемента массива, нужно обратиться к нему по ключу. Например: `$my_array['key1']`.
...
Чтобы узнать есть ли элемент в массиве, нужно использовать функцию `isset`. Например:
